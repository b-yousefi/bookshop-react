...
import { fetchUserOrders } from "../actions/actions_user";
...
class OrderList extends Component {
  ...
  handlePageChange = (event, value) => {
    ...
    this.props.fetchUserOrders(value);
  };
        ...
        <Grid container>
          ...
          <Grid item>
            <Typography
              ...
              gutterBottom
            >
              Last changed at: {order.currentStatus.updatedAt.substr(0, 10)},{" "}
            ...
            <Box flexDirection={"column"} className={classes.root}>
              ...
              >
                {this.props.orders.page &&
                  this.props.orders.page.totalPages > 1 && (
                    <Pagination
                      color="secondary"
                      count={orders.page.totalPages}
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ fetchUserOrders }, dispatch);
}

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(useStyles)(withRouter(OrderList)));
